...
def _sync_decision_cross_ranks(
    ...
    # Not the default group: the ranks that reach this are already out of step with the
    # ones that didn't, so these must not be matchable against runtime collectives.
